...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both backend.css and backend.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/AdminLTE.css": "build/less/backend.less",
          // backend without plugins
          "dist/css/alt/AdminLTE-without-plugins.css": "build/less/backend-without-plugins.less",
          // Separate plugins
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/AdminLTE.min.css": "build/less/backend.less",
          // backend without plugins
          "dist/css/alt/AdminLTE-without-plugins.min.css": "build/less/backend-without-plugins.less",
          // Separate plugins
