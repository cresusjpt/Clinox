...
<?= $form->field($model, 'ddr')->input('date',['max'=>date('Y-m-d')])->label('DDR'); ?>
    ...
    <?= $form->field($model, 'hypothese')->textInput(['maxlength' => true]) ?>
    <?= $form->field($model, 'examencomplementaire')->textInput(['maxlength' => true]) ?>
