    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_3" data-toggle="tab">ETAT DES ASSURANCES</a></li>
            ...
            <div class="tab-content">
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ($analyses as $ligne) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $ligne->coutanalyse*$tauPat ?> F CFA</td>
                                    </tr>
                                    <?php
                                    $i++;
                                    $totalAnalyse += $ligne->coutanalyse*$tauPat;
                                }
                                ?>
                ...
                if(count($consultations)>=1 ) {
                    ...
                    <?php
                    $listeRecapitulatif[] = ['designation' => 'Prestations','montant' => $totalConsultation ];
                                ...
                                foreach ($achats as $achat) {
                                    foreach ($achat->detailachats as $ligne) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $ligne->qteprod*$ligne->coutproduit*$tauPat ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                                        $totalAchat += $ligne->qteprod*$ligne->coutproduit*$tauPat;
                                    }
                                }
                                ?>
                                <tr style="font-size: 1.5em; text-decoration: underline">
                ...
                <?php
                if(count($hospitalisations)>=1 && $tau>0) {
                    ?>
                    <div class="box">
                        <div class="box-header">
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ( $analysesAss as $ligne) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $ligne->coutanalyse*$tau ?> F CFA</td>
                                    </tr>
                                    <?php
                                    $i++;
                                    $totalAnalyse += $ligne->coutanalyse*$tau;
                                }
                                ?>
                                <tr style="font-size: 1.5em; text-decoration: underline">
                                    <td colspan="3">Total Analyses</td>
                ...
                if(count($achatsAss)>=1 && $tau >0) {
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ($achatsAss as $achat) {
                                    foreach ($achat->detailachats as $ligne) {
                                        ...
                                        <?php
                                        $i++;
                                        $totalAchat += $ligne->qteprod*$ligne->coutproduit*$tau;
                                    }
                                }
                                ?>
                                <tr style="font-size: 1.5em; text-decoration: underline">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Liste des achat</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body no-padding">
                            <table class="table table-hover">
                ...
                <?php
                if(count($hospitalisationsAss)>=1 && $tau >0) {
                    ?>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Liste des hospitalisations</h3>
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ($hospitalisationsAss as $ligne) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $ligne->idchbre0->nomchbre ?></td>
                                        <td>
                                            <?= $ligne->coutunitchbre *$quot?> F CFA
                                        </td>
                                        <td><?= $ligne->nbreJours ?> Jour(s)</td>
                                        <td><?= 'Du '.$ligne->datedebut.' au '.$ligne->datefin ?> </td>
                                        <td><?= $ligne->nbreJours*$ligne->coutunitchbre*$quot ?> F CFA</td>

                                    </tr>
                                    <?php
                                    $i++;
                                    $totalHospitalisation += $ligne->nbreJours*$ligne->coutunitchbre*$quot;
                                }
                                ?>
                                <tr style="font-size: 1.5em; text-decoration: underline">
                                    <td colspan="5">Total Hospitalisations</td>
                                ...
                                foreach ($soinsAss as $donnesoin) {
                                    foreach ($donnesoin->detaildonnesoins as $ligne) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $ligne->coutsoin ?> F CFA</td>
                                            <td><?= $ligne->dose ?></td>
                                            <td><?= $ligne->coutsoin*$ligne->dose*$quot ?> F CFA</td>
                                        </tr>
                                        <?php
                                        $i++;
                                        $totalSoin += $ligne->coutsoin*$ligne->dose*$quot;
                                    }
                                }
                                ?>
                                <tr style="font-size: 1.5em; text-decoration: underline">
                ...
                <div class="form-group">
                    <?= Html::a('Facture', ['facview', 'idpayement' => $model->idpayement], ['class' => 'btn btn-primary']) ?>
                </div>
