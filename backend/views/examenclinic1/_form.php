...
<div class="examenclinic-form">
    ...
    <?= $form->field($model, 'motifconsultation')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'hdm')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'appcardivascu')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'apprespiratoire')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'appdigestif')->textarea(['rows' => 6]) ?>
...
//            'format' => 'DD le d MM yyyy'
    ...
    <?= $form->field($model, 'paraclinic')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'cat')->textarea(['rows' => 6]) ?>
