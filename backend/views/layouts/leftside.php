...
//                    ];
            ...
            if ($menu['admenugescons']) //si l'utilisateur à le droit gespat = gérer les consultations
            {
...
//                    ];
                ...
                if ($menu['admenucreatedecaiss']) {
                    $sousmenu[] = [
                        ...
                        'icon' => 'fa fa-cube',
                        'url' => '?r=decaissement%2Fcreate',
                        'active' => $this->context->route == 'decaissement/create'
                    ];
                }
                ...
                if ($menu['admenureaddecaiss']) {
                    $sousmenu[] = [
                        ...
                        'icon' => 'fa fa-list',
                        'url' => '?r=decaissement%2Findex',
                        'active' => $this->context->route == 'decaissement/index'
                    ];
                }
