...
/**
 * This is the model class for table "reduction".
 *
 ...
 */
class Reduction extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public static function getTaux($idtypeconsultation,$idassurance)
    {
        ...
        $req = Yii:: $app->db->createCommand("select taux from reduction where idtypeconsultation=$idtypeconsultation  and idassurance=$idassurance")->query();
