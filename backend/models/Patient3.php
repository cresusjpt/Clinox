...
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function getEffectuerconsultationsNonPayer()
    {
       ...
       // return "SELECT * FROM Effectuerconsultation WHERE payer =0 OR payerassuran=0 OR payerpatient=0 AND indigeant=0 AND idpatient='idpatient'";
    }

    public function getEffectuerconsultationsNonPayerAssu()
    {
