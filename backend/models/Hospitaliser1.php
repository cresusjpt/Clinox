...
class Hospitaliser extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idpatient', 'idhospitalisation', 'idchbre', 'payer','payerassuran', 'indigeant', 'autorisation', 'coutunitchbre','coutbrut','coutassurance', 'tauxassurance'], 'integer'],
