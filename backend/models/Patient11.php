...
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sexpatient' => 'Sexe',
            'tel1patient' => 'Mobile',
            'tel2patient' => 'Tel Personne à prévénir',
 ...
 public function getAchatsNonPayerAss()
    ...
    public function getDonnesoinsAssuranceNonPayer()
    {
        return $this->hasMany(Donnesoins::className(), ['idassurance' => 'idassurance'])->where(['payerassuran' => 0])->andWhere(['indigeant' => 0]);
    }
    ...
    {
        return $this->hasMany(Prelevement::className(), ['idpatient' => 'idpatient'])->inverseOf('idpatient0')->where(['payer' => 0])->andWhere(['indigeant' => 0]);
    }

    public function getEffectueranalysesNonPayerAss()
    {
        return $this->hasMany(Prelevement::className(), ['idpatient' => 'idpatient'])->inverseOf('idpatient0')->where(['payerassuran' => 0])->andWhere(['indigeant' => 0]);
    }
    ...
    public function getEffectuerdemandeanalysesPrelev()
    {
        return $this->hasMany(Demanderanalyse::className(), ['idpatient' => 'idpatient'])->inverseOf('idpatient0')->where(['statut' => 0])->andWhere(['iddemandeanalyse' => 'iddemandeanalyse']);
       // return "SELECT * FROM Demanderanalyse WHERE statut =0 and idpatient='idpatient' and iddemandeanalyse='iddemandeanalyse'";
    }
