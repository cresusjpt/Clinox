...
{
    public static function getTotal($provider, $montantrecu)
    {
        $total = 0;
        foreach ($provider as $item) {
            $total += $item[$montantrecu];
        }
        return $total;
    }
    ...
    {
        return [
            [['idpayement', 'idpatient', 'refpayement', 'montantrecu', 'datepayement', 'iduser'], 'required'],
            [['idpayement', 'idpatient', 'iduser','statutassur'], 'integer'],
